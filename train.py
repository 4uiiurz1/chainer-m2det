...
from m2det import M2Det300, M2Det320, M2Det512
...
def main():
    ...
    parser.add_argument(
        '--model', choices=('ssd300', 'ssd512', 'm2det300', 'm2det320', 'm2det512'), default='m2det320')
    ...
    if args.model == 'ssd300':
        ...
        model = SSD512(
            n_fg_class=len(voc_bbox_label_names),
            pretrained_model='imagenet')
    elif args.model == 'm2det300':
        model = M2Det300(
            n_fg_class=len(voc_bbox_label_names),
            pretrained_model='imagenet')
    elif args.model == 'm2det320':
        model = M2Det320(
            n_fg_class=len(voc_bbox_label_names),
            pretrained_model='imagenet')
    elif args.model == 'm2det512':
        model = M2Det512(
            n_fg_class=len(voc_bbox_label_names),
            pretrained_model='imagenet')
